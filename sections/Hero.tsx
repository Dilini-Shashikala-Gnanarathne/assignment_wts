    ...
    >
      ...
      >
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-linear-to-br from-(--bg-0)/50 via-transparent to-(--bg-2)/40" />
      </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start max-w-400 mx-auto">
            ...
            >
              ...
              >
                ...
                <span className="block text-(--accent-light) drop-shadow-2xl">
                  {rolesecondname}
                </span>
              </h1>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 rounded-full bg-linear-to-r from-(--accent)/0 via-(--accent)/35 to-(--accent-2)/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </button>
