...
export default function Projects() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-(--accent-2)/6 rounded-full blur-3xl" />
      ...
      <div className="relative w-full px-6 sm:px-8 lg:px-12 xl:px-16 max-w-400 mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 flex items-center gap-3 group-hover:text-shadow-blue-800 transition-colors duration-300">
              View All Projects
