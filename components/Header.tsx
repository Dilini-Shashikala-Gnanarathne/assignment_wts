  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-50 pointer-events-auto">
        <div className="absolute inset-0 bg-[#05060a]/50 backdrop-blur-md border-b border-white/10" />
        ...
        <div className="relative px-6 sm:px-8 lg:px-12 py-4 sm:py-5">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              onClick={toggleMenu}
              className="group relative p-2 -m-2 text-white hover:text-(--accent) transition-all duration-300"
            >
              <Menu
                size={28}
